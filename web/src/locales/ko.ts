...
export const ko: Strings = {
  ...
  timelineSummaryLabel: '내 타임라인',
  timelineSummaryMeta: {
    other: '{count}개 위치 포인트 · {start} – {end}',
  },
  changeTimelineButton: '변경',
  timelineSummaryPrivacy: '이 기기에서만 처리됩니다',
  mapThemeLabel: '지도 스타일',
  mapThemeLight: '라이트',
  mapThemeDark: '다크',
  mapThemeNight: '나이트',
  routeColorLabel: '경로 색상',
  routeColorClassic: '클래식',
  routeColorNeon: '네온',
  routeColorSunset: '선셋',
  markerStyleLabel: '마커 스타일',
  ...
  previewPause: '일시정지',
  previewReplay: '다시 보기',
  previewScrubberLabel: '미리보기 타임라인',
  previewPlaceholder: 'Timeline을 불러오거나 데모를 체험한 뒤 미리보기를 눌러 여기에서 확인하세요.',
  previewPlaceholderLoaded: '미리보기를 눌러 지도를 불러오고 여정을 확인하세요.',
  previewPlaceholderConsent: '아래에서 지도 로드에 동의한 뒤 미리보기를 누르세요.',
  settingsGroupJourney: '여정',
  settingsGroupLook: '지도 및 경로',
  settingsGroupExport: '동영상 내보내기',
  settingsGroupAdvanced: '고급',
  settingsGroupPreferences: '환경설정',
  landingExpandHelp: '도움말 및 FAQ 보기',

  previewTitle: '미리보기',
  resultTitle: '내 동영상',
  backToPreviewButton: '미리보기로 돌아가기',
  progressReady: '준비 완료',
  ...
  hintMapConsentRequired: '아래에서 지도 로드에 동의해야 미리보기 및 MP4 생성이 가능합니다.',
