...
export const pagesEn = {
  ...
  faqA2:
    'No. Your Timeline JSON is read locally in the browser. The only network requests are for map tiles from Esri, which may reveal the geographic areas shown in your journey.',
