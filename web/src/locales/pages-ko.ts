/** Korean copy for static sub-pages. */
export const pagesKo = {
  pageLangSwitchAria: '언어',
  pageFooterUnofficial: '비공식 도구 · Google과 제휴하지 않음',
  pageCtaCreateVideo: '여행 영상 만들기 →',
  pageCtaTryApp: 'Timeline Visualizer 체험 →',
  pageCtaBackHome: 'Timeline Visualizer로 돌아가기 →',

  exportHubPageTitle: 'Google 타임라인 내보내기 — Timeline Visualizer',
  exportHubMetaDescription:
    'iPhone 또는 Android의 Google 지도에서 Timeline.json을 내보낸 뒤 Timeline Visualizer에 업로드해 브라우저에서 무료 여행 recap 영상을 만드세요.',
  exportHubOgTitle: 'Google 타임라인 내보내기',
  exportHubOgDescription: 'iPhone 및 Android 단계별 내보내기 가이드.',
  exportHubH1: 'Google 타임라인 내보내기',
  exportHubLead:
    'Timeline Visualizer는 내보낸 Timeline.json 파일을 읽습니다. Google은 타임라인 데이터를 휴대전화에 저장합니다 — 먼저 내보낸 뒤 여기에 업로드해 영상을 만드세요.',
  exportHubIphoneBody:
    'Google 지도에서 설정 → 개인 콘텐츠 → 타임라인 데이터 내보내기. Safari에서 가장 잘 동작합니다.',
  exportHubIphoneLink: 'iPhone 가이드 열기 →',
  exportHubAndroidBody:
    'Google 지도 또는 Android 시스템 설정에서 내보내기. 기기에 따라 두 가지 방법.',
  exportHubAndroidLink: 'Android 가이드 열기 →',
  exportHubNextTitle: '다음 단계',
  exportHubNextStep1: '기기에 Timeline.json을 저장합니다.',
  exportHubNextStep2: '브라우저에서 Timeline Visualizer를 엽니다.',
  exportHubNextStep3: '파일을 업로드하고 영상을 맞춤 설정한 뒤 MP4를 다운로드합니다.',
  exportHubPrivacyNote: '위치 데이터는 기기에 남습니다 — 서버로 업로드되지 않습니다.',

  exportIphonePageTitle: 'iPhone에서 Google 타임라인 내보내기 — Timeline Visualizer',
  exportIphoneMetaDescription:
    'iPhone Google 지도에서 Timeline.json을 내보내고 Timeline Visualizer로 여행 recap 영상을 만드는 단계별 가이드.',
  exportIphoneOgTitle: 'iPhone에서 Google 타임라인 내보내기',
  exportIphoneOgDescription: 'iPhone Google 지도에서 Timeline.json 내보내기 — 6단계.',
  exportIphoneH1: 'iPhone에서 Google 타임라인 내보내기',
  exportIphoneBackLink: '← 모든 내보내기 가이드',
  exportIphoneLeadRest:
    ' · Google 지도는 타임라인 데이터를 기기에 저장합니다. Timeline.json으로 내보낸 뒤 Timeline Visualizer에 업로드해 여행 영상을 만드세요.',
  exportIphonePreviewAlt: 'Timeline Visualizer 출력 예시',
  exportIphoneStepsTitle: '단계',
  exportIphoneStep1: 'iPhone에서 Google Maps 앱을 엽니다.',
  exportIphoneStep2: '오른쪽 상단의 프로필 사진을 탭합니다.',
  exportIphoneStep3: '설정 → 개인 콘텐츠를 탭합니다.',
  exportIphoneStep4: '타임라인 데이터 내보내기를 탭합니다.',
  exportIphoneStep5: 'Files 앱에 Timeline.json으로 저장합니다.',
  exportIphoneStep6: 'Safari에서 Timeline Visualizer로 돌아와 파일을 업로드합니다.',
  exportIphoneTipsTitle: '팁',
  exportIphoneTip1: '1년치 데이터는 30–70MB일 수 있습니다. 가능하면 Wi‑Fi를 사용하세요.',
  exportIphoneTip2: 'Safari에서 WebCodecs H.264 인코딩 지원이 가장 좋습니다.',
  exportIphoneTip3: 'Safari 공유 메뉴에서 홈 화면에 추가해 두면 편리합니다.',
  exportIphoneTip4Prefix: '파일이 없나요? ',
  exportIphoneTip4Link: '데모 여행 체험',
  exportIphoneTip4Suffix: '으로 먼저 사용법을 확인하세요.',
  exportIphoneNextTitle: '다음 단계',
  exportIphoneNextBody:
    '날짜 범위를 선택하고 TikTok/Reels용 Portrait 형식을 고른 뒤 MP4를 만드세요 — 데이터 업로드 없이.',

  exportAndroidPageTitle: 'Android에서 Google 타임라인 내보내기 — Timeline Visualizer',
  exportAndroidMetaDescription:
    'Android Google 지도에서 Timeline.json을 내보내고 Timeline Visualizer로 여행 recap 영상을 만드는 단계별 가이드.',
  exportAndroidOgTitle: 'Android에서 Google 타임라인 내보내기',
  exportAndroidOgDescription: 'Android Google 지도에서 Timeline.json 내보내기 — 두 가지 방법.',
  exportAndroidH1: 'Android에서 Google 타임라인 내보내기',
  exportAndroidBackLink: '← 모든 내보내기 가이드',
  exportAndroidLeadRest:
    ' · Android 설정 또는 Google 지도에서 위치 기록을 내보낸 뒤 움직이는 여행 영상으로 만드세요.',
  exportAndroidPreviewAlt: 'Timeline Visualizer 출력 예시',
  exportAndroidMethod1Title: '방법 1: 휴대전화 설정 (권장)',
  exportAndroidMethod1Step1: '휴대전화 설정을 엽니다.',
  exportAndroidMethod1Step2: '위치 → 위치 서비스 → 타임라인으로 이동합니다.',
  exportAndroidMethod1Step3: '타임라인 데이터 내보내기 → 계속을 탭합니다.',
  exportAndroidMethod1Step4: 'Timeline.json을 다운로드 또는 찾기 쉬운 폴더에 저장합니다.',
  exportAndroidMethod2Title: '방법 2: Google Maps 앱',
  exportAndroidMethod2Step1: 'Google Maps를 열고 프로필 사진을 탭합니다.',
  exportAndroidMethod2Step2: '내 타임라인을 탭합니다.',
  exportAndroidMethod2Step3: '메뉴(⋮) → 위치 및 개인정보 설정을 엽니다.',
  exportAndroidMethod2Step4: '타임라인 데이터 내보내기를 탭하고 JSON 파일을 저장합니다.',
  exportAndroidNextTitle: '다음 단계',
  exportAndroidNextBody1:
    'Chrome 또는 Edge에서 Timeline Visualizer를 열고 파일을 업로드해 MP4를 만드세요. 데이터는 기기에 남습니다.',
  exportAndroidNextBody2Prefix: '파일이 없나요? ',
  exportAndroidNextBody2Link: '데모 여행 체험',
  exportAndroidNextBody2Suffix: '을 먼저 해보세요.',

  faqPageTitle: 'FAQ — Timeline Visualizer',
  faqMetaDescription:
    'Timeline Visualizer FAQ — Google 타임라인 내보내기, 개인정보, 영상 형식, 브라우저 지원.',
  faqOgTitle: 'Timeline Visualizer FAQ',
  faqOgDescription:
    'Timeline Visualizer FAQ — 내보내기, 개인정보, 영상 형식, 브라우저 지원.',
  faqH1: '자주 묻는 질문',
  faqLead: 'Google 타임라인 데이터를 여행 영상으로 만드는 데 필요한 정보.',
  faqQ1: 'Timeline Visualizer란?',
  faqA1:
  ...
  faqA3Suffix: ' 단계를 참고하세요. Google 테이크아웃은 최신 기기 내 타임라인 데이터에 더 이상 해당되지 않는 경우가 많습니다.',
  faqQ4: '어떤 브라우저를 지원하나요?',
  faqA4:
    'MP4 생성에는 WebCodecs H.264 인코딩이 필요합니다. iPhone Safari 16.4+ 및 최신 Chrome/Edge(데스크톱)가 가장 잘 동작합니다. WebCodecs가 없는 브라우저는 데이터 로드만 가능할 수 있습니다.',
  faqQ5: '어떤 영상 형식을 사용할 수 있나요?',
  faqA5:
    'Square(480p–1080p), Portrait(1080×1920, TikTok/Reels), Landscape(1920×1080). 기본값은 Portrait입니다.',
  faqQ6: '내보내기 없이 체험할 수 있나요?',
  faqA6Prefix: '네! 홈페이지에서 ',
  faqA6Bold: '데모 여행 체험',
  faqA6Suffix: '을 클릭하면 가상 샘플 타임라인을 불러와 바로 미리볼 수 있습니다.',
  faqQ7: 'Google 공식 제품인가요?',
  faqA7Prefix: '아니요. Timeline Visualizer는 비공식 서드파티 도구이며 Google과 제휴하지 않습니다. ',
  faqA7AboutLink: '소개',
  ...
  aboutOgTitle: 'Timeline Visualizer 소개',
  aboutOgDescription: 'Google 타임라인 내보내기를 여행 recap 영상으로 바꾸는 무료 비공식 도구.',
  aboutH1: 'Timeline Visualizer 소개',
  aboutLead: 'www.timelinevisualizer.app에서 제공하는 무료·비공개 웹 도구입니다.',
  aboutWhatTitle: '하는 일',
  aboutWhatBody:
    'Timeline Visualizer는 내보낸 Google 지도 위치 기록을 움직이는 여행 recap 영상으로 바꿉니다 — 브라우저에서만, 가입·업로드 없이.',
  aboutGoogleTitle: 'Google과 무관',
  aboutGoogleBody:
    '비공식 서드파티 도구입니다. Google, Google Maps, Timeline은 Google LLC의 상표입니다. Google의 보증이나 제휴 관계는 없습니다.',
  aboutOpenSourceTitle: '오픈 소스',
  aboutOpenSourceBodyPrefix: '핵심 엔진은 ',
  aboutOpenSourceLink: 'google-timeline-visualizer',
  aboutOpenSourceBodyMid: '(@mahler83) 기반이며 MIT License입니다. 자세한 내용은 ',
  aboutOpenSourceAttributionLink: 'ATTRIBUTION',
  aboutOpenSourceBodySuffix: '을 참고하세요.',
  aboutWhyTitle: '만든 이유',
  aboutWhyBody:
